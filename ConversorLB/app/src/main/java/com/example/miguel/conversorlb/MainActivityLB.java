package com.example.miguel.conversorlb;
...
public class MainActivityLB extends AppCompatActivity {
    ...
    public void clickConvert(View v){
        ...
        }else
        {
            ...
            Toast.makeText(MainActivityLB.this,"Las opciones elegidas no tiene un factor de conversor", Toast.LENGTH_SHORT).show();
        }
    }
